...
-- ============================================
-- 正常订单（可退款）
INSERT INTO orders (order_id, user_id, course_id, amount, status, paid_at, has_refunded, refunded_at, refund_amount) VALUES
('O20260622001', 'U1001', 'C2001', 19900, 'PAID', '2026-06-21 10:00:00', FALSE, NULL, NULL),  -- 新订单，未学习
('O20260622002', 'U1001', 'C2002', 24900, 'PAID', '2026-06-20 15:30:00', FALSE, NULL, NULL),  -- 学习进度45%
('O20260622003', 'U1002', 'C2003', 17900, 'PAID', '2026-06-19 09:15:00', FALSE, NULL, NULL),  -- 课程不可用
('O20260622005', 'U1002', 'C2001', 19900, 'PAID', '2026-06-18 14:20:00', FALSE, NULL, NULL),  -- 学习进度15%（重复购买检测）

-- 促销课程订单（特殊限制）
('O20260622006', 'U1003', 'C2004', 29900, 'PAID', '2026-06-22 08:00:00', FALSE, NULL, NULL),  -- 促销课程

-- 已退款订单
('O20260622007', 'U1004', 'C2005', 15900, 'REFUNDED', '2026-06-10 10:00:00', TRUE, '2026-06-11 10:00:00', 15900),  -- 已退款

-- 超过有效期订单
('O20260622008', 'U1001', 'C2005', 15900, 'PAID', '2026-05-01 10:00:00', FALSE, NULL, NULL),  -- 超过7天

-- 待支付订单
('O20260622009', 'U1003', 'C2001', 19900, 'PENDING', NULL, FALSE, NULL, NULL);  -- 未支付
